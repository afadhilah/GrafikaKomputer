function main(){
    ...
    // Geometry huruf FA5 sudah dibangun di data.js (buildFA5) sebagai kumpulan balok
    ...
    // normal ter-interleave dalam vertices (tidak perlu buffer terpisah)

    console.log('Total floats:', vertices.length, 'total vertex:', vertices.length/9);
    ...
    var offset = 0;
    var count = vertices.length / 9; // 9 elemen per vertex

    var model = glMatrix.mat4.create();
    var view = glMatrix.mat4.create();
    var camera = [0, 0.1, 3.2]; // mundurkan kamera sedikit agar seluruh rangkaian huruf terlihat
    ...
    glMatrix.mat4.scale(model, model, [0.9, 0.9, 0.9]);
    function render() {
        if(!freeze){
